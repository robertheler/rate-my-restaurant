...
COPY restaurants (name, address, phone, website, costrating, review, opens, closes, reservationslot) FROM '/Users/robertheler/Desktop/Hack Reactor/SDC/reservations/database/data/restaurants.csv' DELIMITER ',' CSV HEADER;

COPY tables (restaurant_id, capacity) FROM '/Users/robertheler/Desktop/Hack Reactor/SDC/reservations/database/data/tables.csv' DELIMITER ',' CSV HEADER;

COPY availability (table_id, date, times) FROM '/Users/robertheler/Desktop/Hack Reactor/SDC/reservations/database/data/availability1.csv' DELIMITER ',' CSV HEADER;

COPY availability (table_id, date, times) FROM '/Users/robertheler/Desktop/Hack Reactor/SDC/reservations/database/data/availability2.csv' DELIMITER ',' CSV HEADER;
